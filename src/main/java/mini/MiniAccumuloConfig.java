...
/**
 * Holds configuration for {@link org.apache.accumulo.minicluster.MiniAccumuloCluster}. Required configurations must be passed to constructor and all other configurations are optional.
 *
 * @since 1.5.0
 */
...
public class MiniAccumuloConfig {
    ...
    public MiniAccumuloConfig(File dir, String instanceName, String rootPassword) {
        this.dir = dir;
